...
> **关于本项目**
>
> 作者：[@Jone-PNG](https://github.com/Jone-PNG)
>
> 项目起步时参考了 [zuijiu888/Campus-Flow](https://github.com/zuijiu888/Campus-Flow) 的表单认证实现——那是一个面向河北水利电力学院移动校园网的小工具，只能向固定地址提交一次表单。
>
> 在此基础上，本版本重写了认证内核，把它改成声明式的「认证配方」引擎，让不同学校只需改配置就能适配自己的门户；并修复了若干影响通用性的问题（响应字符集、JSON 接口、多步认证、构建脚本等）。这部分是全新的。
>
> 原始项目未声明开源许可证，其原始代码的版权归原作者所有；根目录的 MIT 许可证覆盖本项目新增与修改的部分。欢迎在 issue 里反馈适配问题。
